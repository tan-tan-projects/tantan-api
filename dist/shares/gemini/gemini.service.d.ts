...
export declare class GeminiService {
    ...
    private readonly AI_SALES_SYSTEM_PROMPT;
    private readonly SEARCH_PORTFOLIOS_TOOL;
    private readonly PROJECT_REQUIREMENTS_SCHEMA;
    private readonly PROJECT_CONFIRMATION_SCHEMA;
    constructor(config: ConfigService, logger: LoggerService);
    generate(input: string, previousInteractionId?: string): Promise<Omit<{
    ...
    continueWithFunctionResult(interactionId: string, name: string, callId: string, result: unknown): Promise<Omit<{
        agent?: ((string & {}) | "deep-research-pro-preview-12-2025" | "deep-research-preview-04-2026" | "deep-research-max-preview-04-2026" | "antigravity-preview-05-2026") | undefined;
        agent_config?: {
            max_total_tokens?: string | undefined;
            model?: string | undefined;
    ...
    extractProjectRequirements(previousInteractionId: string): Promise<{
        interaction: Omit<{
            agent?: ((string & {}) | "deep-research-pro-preview-12-2025" | "deep-research-preview-04-2026" | "deep-research-max-preview-04-2026" | "antigravity-preview-05-2026") | undefined;
            agent_config?: {
                max_total_tokens?: string | undefined;
    ...
    detectProjectConfirmation(previousInteractionId: string, content: string): Promise<{
        interaction: Omit<{
            agent?: ((string & {}) | "deep-research-pro-preview-12-2025" | "deep-research-preview-04-2026" | "deep-research-max-preview-04-2026" | "antigravity-preview-05-2026") | undefined;
            agent_config?: {
                max_total_tokens?: string | undefined;
